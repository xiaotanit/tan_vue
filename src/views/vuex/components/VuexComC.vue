<template>
    <div class="vuex-com-a">
        <div class="title">ComponentC</div>
...
<style scoped class="less">
    .vuex-com-a { border: 5px dashed black; margin: 5px; padding: 5px; color: black; }
    .vuex-com-a .title { font-weight: bold; font-size: 24px; }
</style>